...
function ContactUs() {
  ...
  return (
    <div className="relative w-full bg-cover bg-center min-h-screen px-4 sm:px-8 md:px-12 lg:px-20 xl:px-32 font-serif animate__animated animate__fadeIn mt-20">
      <div
        className="relative z-10 flex flex-col items-center justify-center w-full"
        style={{ backgroundImage: "url(/contact.jpg)" }}
      >
        <div className="mt-24 w-full text-center animate__animated animate__fadeInDown">
        ...
        <div className="relative mt-10 w-full max-w-7xl flex flex-col lg:flex-row gap-6 animate__animated animate__fadeInUp">
            ...
            <div className="md:w-8/12 mx-auto bg-white/80 backdrop-blur-md border border-white/30 rounded-xl shadow-lg p-6 text-[#2c3e50] hover:shadow-2xl transition-shadow duration-300">
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex items-center hover:text-blue-600 transition-colors">
                  ...
                  <p>
                    82, Suruchi society, next to subhasnagar hall, Ghod-dod Road,
                    Surat, Gujarat, 395001
                  </p>
                </div>
                <p className="hover:underline cursor-pointer">We are here to help you!</p>
                <p className="hover:underline cursor-pointer">Have a great day!</p>
              </div>
            </div>
          </div>
      ...
      <div className="mt-10 w-full max-w-7xl z-10 animate__animated animate__fadeInUp">
        <iframe
