...
function ContactUs() {
  ...
  return (
    <div
      className="relative w-full bg-cover bg-center min-h-screen px-4 sm:px-8 md:px-12 lg:px-20 xl:px-32"
      
    >
      <div className="relative z-10 flex flex-col items-center justify-center w-full " style={{ backgroundImage: "url(/contact.jpg)" }}>
            ...
            <div className="md:w-8/12 mx-auto bg-white/80 backdrop-blur-md border border-white/30 rounded-xl shadow-lg p-6 text-[#2c3e50] hover:shadow-2xl transition-shadow duration-300">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex items-center hover:text-blue-600 transition-colors">
                  ...
                  <p>123, Example Street, City, State, 123456</p>
                </div>
          ...
          <div className="w-full lg:w-1/2">
            <div className="bg-[#2c3e50]/90 text-white rounded-xl shadow-lg p-6 hover:shadow-2xl transition-shadow duration-300">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full bg-amber-400 text-white py-2 rounded hover:bg-white hover:text-black border border-transparent hover:border-amber-400 transition-all duration-300 font-semibold"
                >
                  Send Message
                </button>
              </form>
      ...
      <div className="mt-10 w-full max-w-7xl z-10">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3720.510691337802!2d72.80867077958737!3d21.171862430268888!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be04e0da976193f%3A0x253e29d6046c86d0!2sSuruchi%20Society%2C%2053%2C%20Jamna%20Nagar%2C%20Subhash%20Nagar%2C%20Athwa%2C%20Surat%2C%20Gujarat%20395007!5e0!3m2!1sen!2sin!4v1752170979482!5m2!1sen!2sin"
          width="100%"
          height="450"
          style={{ border: 0 }}
          allowFullScreen=""
